...
const FileUploader = () => {
  ...
  const fetchFiles = async () => {
    setLoading(true);
    try {
      const res = await axios.get("/employee-files/files", getAuthHeaders());
  ...
  const confirmRename = async () => {
    ...
    setRenaming(true);
    try {
      await axios.put(`/employee-files/rename/${fileToRename._id}`, { newName: newFileName }, getAuthHeaders());
  ...
  const confirmDelete = async () => {
    setDeleting(true);
    try {
      await axios.delete(`/employee-files/delete/${fileToDelete._id}`, getAuthHeaders());
